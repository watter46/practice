<div class="w-full">
    <div class="h-8 py-5 text-sm font-semibold flex justify-start">
        ...
        <div class="mx-2 flex justify-center items-center hover-underline"
            ...
            <svg width="20px" height="20px" class="mr-1" fill="gray" viewBox="0 0 122.88 122.88">
